...
namespace ShadowedSouls.Items
{
    ...
    #region Variables
        ...
        private Vector3 grapplePoint, adjustmentPoint;      
        private GameObject hookTmp;                        
        private GameObject hookedObj;                     
        private Rigidbody trb;                             


        [SerializeField] private bool isSecured = false, firedHook = false;     
        [SerializeField] private bool isTargeting = false;                      
        private Rigidbody rb;                                                   

        private float step;                                                     
        private float momentum;                                               
        private bool onGrappleSurface;                                          
